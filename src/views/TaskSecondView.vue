<template>
    <div class="task__wrapper">
      ...
      <div class="task__wrapper__list">
        <div class="task__wrapper__item" v-for="(task, id) in getStageTasks('2')" :key="id">
  ...
  export default {
    ...
    methods: {
      ...mapMutations(['setArrayTask', 'newValue', 'setTimeStart', 'setTimeEnd', 'saveInLocalStorage', 'pushInBendArray', 'setCurrentStage',]),
      deleteItem(count, id) {
        if (count === 0) {
          this.pushInBendArray(id); 
          this.setTimeEnd(id);
